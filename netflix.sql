...
CREATE TABLE `users` (
  ...
  `isSubscriber` tinyint(1) DEFAULT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `users` (`id`, `email`, `password`, `active`, `isSubscriber`, `createdAt`, `updatedAt`) VALUES
(1, 'bunny@me.com', 'bunny', 1, 1, '2023-01-28 10:13:14', '2023-01-28 10:13:14'),
(2, 'lola@me.com', 'lola', 1, 0, '2023-01-28 10:13:14', '2023-01-28 10:13:14');
